                        ...
                        <div className="about-grid">
                            <div className="about-content">
                                ...
                                <p className="about-description">
                                    ...
                                    Developers are often told to grind away in silence, following the same path as everyone else. Why not spice things up?
                                </p>
                                <p className="about-description">
                                    Our story? It’s simple. We believe in creating fun, unconventional ways to make coding not just a job, but a lifestyle.
                                    We’re all about finding creative, and often sarcastic vibes to make development exciting.
                                    Whether it’s gamifying the learning process, turning projects into quirky challenges, or finding alternative ways to build funds
                                    (think side projects, hackathons, and unexpected opportunities), we make sure the grind doesn’t feel like a grind.
                                </p>
                                <p className="about-description">
                                    At The Sarcastic Geeks Trybe, we’re here to help you level up both in your skills and your financial game.
                                    We believe that being part of this community means getting paid, having fun, and building something you can be proud of—all while laughing at the chaos along the way.
                                </p>
                            </div>
                        ...
                        <div className="features-grid">
                            <div className="feature-card">
                                ...
                                <p className="card-description">
                                    Get resources, mentorship, and community backing to launch and grow your startup.
                                </p>
                            </div>
                            ...
                            <div className="feature-card">
                                ...
                                <p className="card-description">
                                    Leverage our community backing to validate ideas and gain traction for your projects.
                                </p>
                            </div>
                            ...
                            <div className="feature-card">
                                ...
                                <p className="card-description">
                                    Learn and build at the intersection of artificial intelligence and blockchain technology.
                                </p>
                            </div>
                            ...
                            <div className="feature-card">
                                ...
                                <p className="card-description">
                                    Participate in activities to earn in-app points that will become tokens with real value.
                                </p>
                            </div>
                            ...
                            <div className="feature-card">
                                ...
                                <p className="card-description">
                                    Helping developers discover new career opportunities and connect with companies looking for their skills.
                                </p>
                            </div>
                    ...
                    <div className="containers">
                        ...
                        <div className="cta-content">
                            ...
                            <p className="cta-description">
                                Create your profile, connect with other geeks, and start building the future together.
                            </p>
                            <button
                                className="app-container center-btn"
                                onClick={() => window.open('https://x.com/sarcasticgeek4u', '_blank')}>
                                Join the X Family
                            </button>
                        </div>
                    </div>
                        ...
                        <div className="community-grid">
                            <div>
                                ...
                                <p className="community-description">
                                    ...
                                    Host interactive X Spaces, play in-app games, collaborate on gigs, explore new technologies, and discover new ways to monetize the craft — A normal life is boring.
                                </p>
